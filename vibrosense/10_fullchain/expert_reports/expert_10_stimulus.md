# Expert 10: Stimulus and CWRU Data Analysis

## CWRU Data Status
- Data directory found: NOT FOUND anywhere
- .mat files found: 0
  None
...
|-----------|-----------|--------|
| Normal | 97.mat (normal, 0hp) | NEED DOWNLOAD |
| Inner Race | 105.mat (IR007, 0hp) | NEED DOWNLOAD |
| Ball | 118.mat (B007, 0hp) | NEED DOWNLOAD |
| Outer Race | 130.mat (OR007, 0hp) | NEED DOWNLOAD |
...
## Python Dependencies
- numpy: AVAILABLE
- scipy: NOT INSTALLED — needed for .mat files

## Existing Stimuli
No stimuli generated yet

## Feature Vector Test Stimulus
- feature_vectors_spice.txt: EXISTS
