...
T {BLOCK 05: OV COMPARATOR} -650 -1050 0 0 1.0 1.0 {layer=4}
...
T {Threshold: PVDD > 5.5V → ov_flag = HIGH} -650 -905 0 0 0.3 0.3 {layer=5}
T {NOTE: Diff pair inputs SWAPPED vs UV  (M1 = vref, M2 = mid_ov)} -650 -875 0 0 0.28 0.28 {layer=4}
T {.subckt ov_comparator  pvdd  vref  ov_flag  vdd_comp  gnd  en} -650 -845 0 0 0.28 0.28 {layer=13}
...
C {/usr/share/xschem/xschem_library/devices/opin.sym} -470 -760 0 0 {name=p6 lab=ov_flag}
...
C {/usr/share/xschem/xschem_library/devices/title.sym} -650 830 0 0 {name=l1 author="Block 05: OV Comparator -- Analog AI Chips PVDD LDO Regulator"}

* ================================================================
* RESISTIVE DIVIDER: XR_top (pvdd → mid_ov) + XR_bot (mid_ov → gnd)
* ratio = 146/(500+146) = 0.22582 → trip at 5.431V (adjusted for hyst)
* ================================================================
...
T {mid_ov} -485 -535 0 0 0.3 0.3 {layer=8}

* --- XR_bot: Bottom divider resistor (W=2 L=146) ---
T {XR_bot} -580 -370 0 0 0.25 0.25 {layer=13}
T {W=2 L=146} -580 -348 0 0 0.2 0.2 {layer=5}
T {~146k} -580 -326 0 0 0.18 0.18 {}
...
* --- XR_hyst: Hysteresis resistor (W=1 L=4000, ov_flag → mid_ov) ---
T {XR_hyst} -320 -660 0 0 0.25 0.25 {layer=13}
T {W=1 L=4000} -320 -638 0 0 0.2 0.2 {layer=5}
T {~8M hyst} -320 -616 0 0 0.18 0.18 {}
T {ov_flag feedback} -320 -594 0 0 0.18 0.18 {layer=5}
...
N -310 -570 -310 -600 {lab=ov_flag}
C {/usr/share/xschem/xschem_library/devices/lab_pin.sym} -310 -600 2 0 {name=l_of1 sig_type=std_logic lab=ov_flag}
N -310 -510 -310 -480 {lab=mid_ov}
C {/usr/share/xschem/xschem_library/devices/lab_pin.sym} -310 -480 0 0 {name=l_mo1 sig_type=std_logic lab=mid_ov}
...
* ================================================================
* NMOS DIFFERENTIAL PAIR: XM1 (vref) + XM2 (mid_ov)
* NOTE: Inputs SWAPPED vs UV comparator
* ================================================================

* --- XM1: Diff pair left (W=2u L=1u, gate=vref) ---
T {XM1} 180 -360 0 0 0.25 0.25 {layer=13}
T {W=2u L=1u} 180 -338 0 0 0.2 0.2 {layer=5}
T {gate=vref} 180 -316 0 0 0.18 0.18 {layer=5}
...
N 240 -440 170 -440 {lab=vref}
C {/usr/share/xschem/xschem_library/devices/lab_pin.sym} 170 -440 0 0 {name=l_vr1 sig_type=std_logic lab=vref}
T {out_p} 285 -565 0 0 0.3 0.3 {layer=8}

* --- XM2: Diff pair right (W=2u L=1u, gate=mid_ov) ---
T {XM2} 450 -360 0 0 0.25 0.25 {layer=13}
T {W=2u L=1u} 450 -338 0 0 0.2 0.2 {layer=5}
T {gate=mid_ov} 450 -316 0 0 0.18 0.18 {layer=5}
...
N 510 -440 440 -440 {lab=mid_ov}
C {/usr/share/xschem/xschem_library/devices/lab_pin.sym} 440 -440 0 0 {name=l_mo2 sig_type=std_logic lab=mid_ov}
...
* ================================================================
* NOR OUTPUT GATE: ov_flag = NOR(out_n, en_bar)
...
N 1150 -470 1150 -410 {lab=ov_flag}
...
N 1150 -350 1150 -410 {lab=ov_flag}
...
N 1380 -350 1380 -410 {lab=ov_flag}
...
* --- ov_flag output connection ---
N 1150 -410 1380 -410 {lab=ov_flag}
N 1260 -410 1260 -390 {lab=ov_flag}
T {ov_flag} 1265 -395 0 0 0.35 0.35 {layer=4}
N 1380 -410 1500 -410 {lab=ov_flag}
C {/usr/share/xschem/xschem_library/devices/lab_pin.sym} 1500 -410 2 0 {name=l_fl sig_type=std_logic lab=ov_flag}
T {HIGH when PVDD > 5.5V} 1265 -370 0 0 0.22 0.22 {}

* ================================================================
* SIGNAL FLOW ANNOTATIONS
* ================================================================
T {PVDD → R_top/R_bot divider → mid_ov (~1.226V at trip)} -520 -200 0 0 0.22 0.22 {layer=5}
T {Diff pair: XM1(vref) vs XM2(mid_ov) → out_n  [SWAPPED vs UV]} 180 -200 0 0 0.22 0.22 {layer=5}
T {NOR(out_n, en_bar) → ov_flag HIGH when OV detected and enabled} 850 -200 0 0 0.22 0.22 {layer=5}
T {Hysteresis: XR_hyst feeds ov_flag back to mid_ov (positive feedback)} -320 -200 0 0 0.22 0.22 {layer=5}
