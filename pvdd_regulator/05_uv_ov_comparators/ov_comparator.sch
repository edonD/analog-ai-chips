...
S {}
E {}
T {OV COMPARATOR} 100 -750 0 6 0.7 0.7 {}
T {Block 05 — PVDD Overvoltage Detector} 100 -700 0 8 0.4 0.4 {}
T {NMOS diff pair + PMOS mirror | 1.8V supply | Threshold ~5.5V} 100 -660 0 8 0.35 0.35 {}
T {NOTE: Diff pair inputs SWAPPED vs UV (M1=vref, M2=mid_ov)} 100 -630 0 5 0.3 0.3 {}
...
N 120 -560 200 -560 {}
N 200 -420 200 -370 {}
C {res.sym} 200 -280 0 0 {name=R_bot value=146k}
N 200 -370 200 -310 {}
N 200 -250 200 -210 {}
C {gnd.sym} 200 -210 0 0 {name=l1 lab=GND}
N 200 -370 350 -370 {}
C {lab_pin.sym} 350 -370 0 2 {name=p1 sig_type=std_logic lab=mid_ov}
B 2 360 -430 650 -310 {dash=3}
T {HYSTERESIS FEEDBACK} 375 -425 0 5 0.25 0.25 {}
T {R_hyst from ov_flag} 375 -400 0 5 0.2 0.2 {}
C {res.sym} 500 -370 0 1 {name=R_hyst value=8M}
N 470 -370 350 -370 {}
N 530 -370 620 -370 {}
C {lab_pin.sym} 620 -370 0 2 {name=p1 sig_type=std_logic lab=ov_flag}
...
T {NMOS diff pair (M1=vref, M2=mid_ov)} 920 -380 0 5 0.25 0.25 {}
C {nmos4.sym} 980 -290 0 0 {name=XM1 model=sky130_fd_pr__nfet_01v8 w=2u l=1u m=1}
N 1000 -320 1000 -440 {}
C {lab_pin.sym} 930 -290 0 0 {name=p1 sig_type=std_logic lab=vref}
N 930 -290 960 -290 {}
N 1000 -260 1000 -230 {}
N 1000 -290 1020 -290 {}
N 1020 -290 1020 -190 {}
...
N 1220 -320 1220 -440 {}
C {lab_pin.sym} 1150 -290 0 0 {name=p1 sig_type=std_logic lab=mid_ov}
N 1150 -290 1180 -290 {}
N 1220 -260 1220 -230 {}
N 1220 -290 1240 -290 {}
N 1240 -290 1240 -190 {}
...
N 1660 -180 1650 -200 {}
N 1720 -180 1780 -180 {}
C {lab_pin.sym} 1780 -180 0 2 {name=p1 sig_type=std_logic lab=ov_flag}
